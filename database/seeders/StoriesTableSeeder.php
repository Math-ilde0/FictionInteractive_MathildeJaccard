        ...
        $stories = [
            [
                ...
                'chapters' => [
                    ...
                    [
                        'chapter_number' => 3,
                        'content' => 'Tu as finalement cédé. La fatigue a gagné. Tu es resté au lit. Au début, c\'était agréable : la chaleur des draps, le silence de l\'appartement, la sensation de suspendre le temps. Tu t\'es autorisé à respirer, à exister sans pression. Tu as fermé les yeux, le corps engourdi, le cœur ralenti. Mais cette paix n\'a pas duré. Une heure plus tard, la culpabilité s\'est faufilée entre les plis de ta couette. Elle s\'est installée là, contre ta nuque, pesante. Chaque minute passée à ne rien faire devient un reproche muet. Ton cerveau recommence à tourner à vide : "Pourquoi tu n\'es pas levé ?", "Tu vas tout rater", "Tu n\'as aucune discipline." Le soleil grimpe dans le ciel. Sa lumière se glisse à travers les rideaux et t\'aveugle. Le monde avance sans toi. Tu restes figé dans ton lit, comme si la gravité avait triplé. Ton téléphone vibre, mais tu ne veux pas regarder. Tu sais déjà ce que tu vas y trouver : rappels, notifications, échéances. Il est presque midi quand tu trouves enfin le courage de te lever. Tu poses les pieds au sol avec l\'impression de porter une armure invisible. Le calme du matin s\'est transformé en tension sourde. Et pourtant, il faut commencer quelque part. Même maintenant.',
                        'stress_level' => 0,
                        'stress_impact' => 0,
